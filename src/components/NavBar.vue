<template>
  <div class="navbar">
    ...
    <!--Logo-->
    <div class="flex-1">
      <a href="https://www.pylinker.com" class="btn btn-ghost text-xl text-primary">Pylinker</a>
    </div>

    <!--Search Bar-->
    <div class="flex-none gap-2">
      <div class="form-control">
        <input type="text" placeholder="Search" class="input input-bordered w-24 text-text-100 md:w-auto" />
      </div>
