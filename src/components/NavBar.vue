<template>
  <div class="navbar">
    ...
    <!--Logo-->
    <div class="flex-1">
      <a href="https://www.pylinker.com" class="btn btn-ghost text-xl text-primary hover:text-secondary">Pylinker</a>
    </div>

    <!--Search Bar-->
    <div class="flex-none gap-2">
      <div class="form-control">
        <input type="text" placeholder="Search" class="input input-bordered w-24 text-text md:w-auto" />
      </div>
      ...
      <div class="dropdown dropdown-end">
        <label tabindex="0" class="btn btn-ghost btn-circle avatar">
          <div class="w-10 rounded-full">
            <img src="../../svgs/gear.svg" alt="settings">
          </div>
        </label>
